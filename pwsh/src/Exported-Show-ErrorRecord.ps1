function Show-ErrorRecord {
    ...
    .example
        gi 'asdfsadf'
        Show-ErrorRecord -obj $Error[0] -depth 2 -indent 4
    .example
        Show-ErrorRecord -obj $Error[0] -depth 2 -indent 8
        Show-ErrorRecord -obj $Error -indent 3
    .LINK
        https://github.com/PowerShell/PowerShell/blob/master/src/Microsoft.PowerShell.Commands.Utility/commands/utility/Get-Error.cs
    #>
    param(
        $obj,
        [int]$indent = 0,
