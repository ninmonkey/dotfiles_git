...
alias ls="\ls --size -C --human-readable --group-directories-first --almost-all --color=auto"

# Output
#   -rw-r--r-- 1 nin 197609  72K 2021/01/26  Untitled.png
#   drwxr-xr-x 1 nin 197609    0 2021/01/25  Documents
alias ls_date="\ls -l --sort=time --time-style=+%G/%m/%d --human-readable --almost-all --color=auto"
alias lsd="fd --type d"
alias lsf="fd --type f"
